...
parser.add_argument('--data_name', type=str, default="android", choices=['android','weibo', 'memetracker', 'twitter', 'douban','christianity'], help="dataset")
parser.add_argument('--max_len', type=int, default=200,help="max sequence length")
...
parser.add_argument('--alpha', type=float, default= 0.3, help='CE Loss') 
parser.add_argument('--beta2', type=float, default= 0.25, help='CE loss')  
parser.add_argument('--beta3', type=float, default= 0.3, help='VCD Loss')  

# parameters of DiffHidden
...
parser.add_argument('--lam', type=float, default=0.001, help='the mean and var of gauss distribution')
parser.add_argument('--dropout', type=float, default=0.1, help='dropout ratio')

# parameters of DucDiff
...
parser.add_argument('--beta_sche', type=str, default='sqrt', help='the method of generate betas')
parser.add_argument('--lr', type=float, default=0.005, help='learning rate')
parser.add_argument('--optimizer', type=str, default='Adam', choices=['SGD', 'Adam'])
parser.add_argument('--weight_decay', type=float, default=0, help='L2 regularization')
parser.add_argument('--momentum', type=float, default=None, help='SGD momentum')

# parameters of DiffuseModel
